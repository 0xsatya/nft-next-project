...
import { CONNECT_STATUS, SALE_STATUS } from '../../../../src/utils/Interface'
...
const ConnectButton = (props: ConnectButton) => {
  const { connectStatus = 0, saleStatus = 0, setShowMintBox } = props
  ...
  return (
    <CtaButton>
      ...
      <FirstLayer />
      <SecondLayer />
      {saleStatus === SALE_STATUS.OFFSALE && (
        <ButtonText>
      ...
      {saleStatus === SALE_STATUS.ONSALE &&
        connectStatus === CONNECT_STATUS.CONNECT && (
          <ButtonTextClick onClick={() => setShowMintBox(true)}>
            Connect
          </ButtonTextClick>
        )}
      <RightCorner>
