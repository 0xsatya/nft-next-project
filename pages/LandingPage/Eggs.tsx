    ...
    <EggsInfoList>
      ...
      <EggsInfo>
        <div className="text-position-fix">
          ...
          <Text>0.08 ETH to unlock any Bunny</Text>
          <Text>
            0.12 ETH for more chance to unlock a Super Rare (SRB/SSRB/SB+) Bunny
            and special exclusive perks
          </Text>
        </div>
  ...
  return (
    <EggListOuterWrap>
      ...
      <EggsList>
        ...
        />
        <ListItem>
          Discord-based community for all Da Bunny NFT holders
        </ListItem>
        <ListItem>
          Members-only access to <span>Rabbit Hole</span>, an exclusive
          clubhouse whose benefits and offerings will unlock with roadmap
          milestone activations (see below)
        </ListItem>
        <ListItem>
          We support <span>real rabbits</span> globally by donating of 5% of NFT
          sales net proceeds to the House Rabbit Society
        </ListItem>
      </EggsList>
    </EggListOuterWrap>
  )
