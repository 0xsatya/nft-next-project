    ...
    <Section>
      <InnerWrap id="roadmap">
        <RocketBunny rocketOnScreen={rocketOnScreen}>
          <Waypoint onEnter={rocketAppears} />
          <Image width={2228} height={607} src="/img/rocket_bunny.png" alt="" />
        </RocketBunny>
        <ActivationsBox>
          <VectorWrap>
            <TopVector />
          ...
          <BunnyImage>
            <Image width={650} height={809} src="/img/bunny4.png" alt="" />
          </BunnyImage>
        </ActivationsBox>
        <CalendarLimit>
          <CalendarTitleWrap>
            <CalendarTitle>Event Calendar</CalendarTitle>
            <CalendarTitleShadow>Event Calendar</CalendarTitleShadow>
          </CalendarTitleWrap>
          <CalendarBoxOne />
          <CalendarBoxTwo />
          <CalendarBoxThree />
