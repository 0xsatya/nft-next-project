...
const BunniesCarousel = () => {
  ...
  const pressHold = () => {
    let clicked = false;
    let count: number, direction: number, sizeSlider: number, state: number, target;
  ...
  return (
    <SectionWrap>
      ...
      <Paragraph>
      DaBunny is a tribe of 9,999 algorithmically-incubated bunny avatars that reside on the Ethereum blockchain. Generation 1 is incubated from a randomized combination of more than 200 unique traits, out of 4,320,000 total possibilities. Each bunny has a unique character and appearance which makes him/her “Da” Bunny....
      <span className='line-break'></span>
      The NFT grants you membership access to DaBunny Island, the metaverse campground for live music events, a 24/7 music streaming channel, digital & physical merchandise, P2E games, a community ERC20 token and much more!
      <span className='line-break'></span>
 Join DaBunny NFT’s Discord early to get whitelisted and receive information on giveaways & community events. 
      </Paragraph>
