...
const Symbol = ({ children, tabindex }: { children: ReactChild, tabindex: string }) => {
  return (
    <div tabIndex={Number(tabindex)}>
      <svg
        width="23"
        height="37"
        viewBox="0 0 23 37"
...
const Hero = ({provider, address, balance,connectStatus, saleStatus, network, onMintToken, onConnectWallet}: Props) => {
    ...
    const onMintToken1 = async (e: any) => {
        ...
        await onMintToken(e, bunnyCount, isPresell);
    ...
    return (
        <Section>
            ...
            <ConnectButton setShowMintBox={setShowMintBox} connectStatus = {connectStatus} saleStatus={saleStatus} onConnectWallet={onConnectWallet} />
            <JoinBoxMobile>
                <a rel="noreferrer" target="_blank" href={DISCORD_LINK}>
                    <Arrow />
                    <JoinCta>Join our Discord Channel</JoinCta>
            ...
            {showMintBox && (
                <MintBox>
                    ...
                    <MintTop>
                        <Symbol tabindex="1">0.08</Symbol>
                        <Symbol tabindex="2">0.12</Symbol>
                    </MintTop>
