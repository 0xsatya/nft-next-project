...
const Evolution = () => {
  ...
  return (
    <Section id="rabbit" >
      ...
      <InnerWrap>
        <HeaderWrap>
          <CarrotHeader bgColor="#FFEDAF" padding="1.5625rem 4.0625rem 25px 6.875rem">
        ...
        <BottomText>
        It then occurred to another bunny that “ETH” can trade way more carrots with humans than chocolate eggs. It soon occured to yet another bunny that carrots are too bland for his taste, and he ordered pizza with “ETH” for the first time...
